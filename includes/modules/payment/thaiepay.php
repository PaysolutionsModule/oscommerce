...
// class constructor
    function thaiepay() {
      ...
      if ((int)MODULE_PAYMENT_THAIEPAY_ORDER_STATUS_ID > 0) {
...
// class methods
    function update_status() {
      ...
      if ( ($this->enabled == true) && ((int)MODULE_PAYMENT_THAIEPAY_ZONE > 0) ) {
        $check_flag = false;
    ...
    function process_button() {
      ...
      switch (MODULE_PAYMENT_THAIEPAY_CURRENCY) {
      ...
      switch (MODULE_PAYMENT_THAIEPAY_TEST_STATUS) {
        case 'Always Fail':
          $test_status = 'false';
          break;
        case 'Production':
...
elseif ( $sec_currency == "EUR" )
{
    ...
    function get_error() {
      ...
      return array('title' => MODULE_PAYMENT_THAIEPAY_TEXT_ERROR,
                   'error' => $error);
    }
    ...
    function keys() {
      return array('MODULE_PAYMENT_THAIEPAY_STATUS', 'MODULE_PAYMENT_THAIEPAY_MERCHANT_ID', 'MODULE_PAYMENT_THAIEPAY_CURRENCY', 'MODULE_PAYMENT_THAIEPAY_TEST_STATUS', 'MODULE_PAYMENT_THAIEPAY_ZONE', 'MODULE_PAYMENT_THAIEPAY_ORDER_STATUS_ID', 'MODULE_PAYMENT_THAIEPAY_SORT_ORDER');
    }
  }
?>
